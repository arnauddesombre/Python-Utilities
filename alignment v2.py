...
def align_(string1, string2, penaltyGap=penaltyGap_, penaltySubstitution=penaltySubstitution_):
    if string1 == "":
        s1 = gap * len(string2)
...
def memoize(function):
    dictionary = {}
    def helper(string1, string2, penaltyGap=penaltyGap_, penaltySubstitution=penaltySubstitution_):
        if (string1, string2) not in dictionary:
            dictionary[(string1, string2)] = function(string1, string2, penaltyGap, penaltySubstitution)
        return dictionary[(string1, string2)]
    return helper

align = memoize(align_)
